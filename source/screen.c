 ...
 * @param the pair number for the to-screen color
 */
 ...
 * @param attr a curses attr
 * @param color the pair number
 * @param the attr for the to-screen color
 */
...
/*
 * Ignore the address warning in this file.  It is generated by wattr_get().
 */
