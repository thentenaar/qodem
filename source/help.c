...
"AVATAR, TTY, and DEBUG emulations can be set to either CP437 (VGA) or\n"
"ISO-8859-1.\n"
"\n"
...
"\n"
"@BOLD{Alt-A} Translate Table @LINK{CONSOLE__ALTA_TRANSLATE,Translate Table,40}\n"
"This brings up the translate table editor.  Both incoming and outgoing\n"
"bytes can be changed or stripped (set to ASCII NUL (0)).  Note that\n"
"translation occurs before both emulation processing and UTF-8\n"
"decoding.\n"
"\n"
...
"do not use ASCII.\n"
"\n"
"The INPUT table changes bytes that are received from the remote side, and\n"
"occur before the bytes are processed by the terminal emulation.  It is\n"
"possible for the INPUT table to completely break the emulation, e.g. if the\n"
"ESC byte (ASCII 027) is changed.\n"
"\n"
"The OUTPUT table changes bytes that are sent to the remote side, and occur\n"
"before keystrokes have been translated by the terminal emulation.\n"
"\n"
"Use the arrow keys (@BOLD{&#x2191;}, @BOLD{&#x2193;}, @BOLD{&#x2190;}, and @BOLD{&#x2192;}) to select a byte to change.  Press @BOLD{Space}\n"
"to bring up an edit textbox, and enter the decimal value of the byte to\n"
"change it to.  Pressing @BOLD{S} switches betweeen the ASCII characters (0 to 127)\n"
"and the high-bit characters (128 to 255).\n"
"\n"
"The Translate Tables have slightly different behavior depending on the\n"
"terminal emulation.  UTF-8 emulations (@BOLD{L_UTF8} and @BOLD{X_UTF8}) only support\n"
"translating bytes in the ASCII range (0 to 127).\n"
"\n"
"\n"
"\n"
...
"    @BOLD{minicom} who licensed their work under the GNU Public License.\n"
"\n"
"    The developers involved in @BOLD{libssh2} who licensed their work under\n"
"    a BSD-like license.\n"
"\n"
...
"\n"
"  @BOLD{Win32} - The Win32 version is a native Windows console-based\n"
"          application that runs on most Win32-based systems\n"
"          including Windows XP, Vista, and Windows 7.  This version\n"
"          may look different depending on how the console window has\n"
"          been set up.\n"
"\n"
...
"glyphs.  If ISO-8859-1 is used, the C0 control characters (0x00 - 0x1F) are\n"
"mapped to the equivalent CP437 glyphs since there are no glyphs defined in\n"
"that range for ISO-8859-1.\n"
"\n"
...
"\n"
"@BOLD{--version}\n"
"Display program version and brief copyright statement.\n"
"\n"
