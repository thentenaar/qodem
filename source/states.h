...
/*
Program states.  First state is always initialization, from there
it can be dialing directory or console.
*/
...
/* Global state, stored in states.c */
