...
#define XCURSCR_DOUBLE_SIZE (XCursesLINES * sizeof(int))
#define XCURSCR_ATRTAB_SIZE (PDC_COLOR_PAIRS * 2 * sizeof(short))
#define XCURSCR_SIZE        (XCURSCR_FLAG_SIZE + XCURSCR_START_SIZE + \
        XCURSCR_LENGTH_SIZE + XCURSCR_DOUBLE_SIZE + XCURSCR_Y_SIZE + \
        XCURSCR_ATRTAB_SIZE + sizeof(XColor))
...
#define XCURSCR_DOUBLE_OFF  (XCURSCR_LENGTH_OFF + XCURSCR_LENGTH_SIZE)
#define XCURSCR_ATRTAB_OFF  (XCURSCR_DOUBLE_OFF + XCURSCR_DOUBLE_SIZE)
